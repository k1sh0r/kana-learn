        ...
        <div className="lg:container flex h-16 items-center justify-between px-4">
          ...
          <div className="flex md:hidden items-center gap-2 ml-auto">
            <Select value={language} onValueChange={setLanguage}>
              <SelectTrigger className="h-9 w-28 px-2 rounded-[0.75rem] border border-input hover:bg-accent hover:text-accent-foreground text-sm font-medium outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 flex items-center gap-2" aria-label="Select language">
